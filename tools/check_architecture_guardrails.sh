...
if (( external_byte_drift_count != 98 )); then
  fail "external naga-oil compose parity byte drift manifest must exact-gate the observed 98 byte-output drifts, got ${external_byte_drift_count}"
fi
